 ...
 * @returns 聚类管理器实例
 */
import { ClusterManager, ClusterOptions, ClusterBasePoint } from "./cluster_manager";
...
export function createClusterManager<T extends ClusterBasePoint = ClusterBasePoint>(
